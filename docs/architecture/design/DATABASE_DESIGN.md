...
> 版本: v1.1 | 日期: 2026-07-31 | 状态: active（历史基础版，被 v2.0 扩展）

> 🔄 **v2.0 扩展（现状核心）**: 基于 tc-imba 全量数据（帕鲁属性/技能/被动/物品/掉落）
> 的完整 **22 表**设计见
> **[DATABASE_DESIGN_TCIMBA_V2.md](./DATABASE_DESIGN_TCIMBA_V2.md)**。
> 本文件为 v1.1 基础 5 表设计（`pal` 表字段已被 v2 扩展列覆盖）。
